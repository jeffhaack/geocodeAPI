...
#############################
csvFile = "#{Rails.root}/db/seed_data/region.csv"
...
###############################
csvFile = "#{Rails.root}/db/seed_data/district.csv"
@results = CSV.read(csvFile)
@results.shift
...
####################################################
csvFile = "#{Rails.root}/db/seed_data/city.csv"
@results = CSV.read(csvFile)
@results.shift
puts "Loading Cities..."
@results.each do |r|
...
#########################################################
csvFile = "#{Rails.root}/db/seed_data/settlement.csv"
@results = CSV.read(csvFile)
@results.shift
...
####################################
csvFile = "#{Rails.root}/db/seed_data/cityDistrict.csv"
@results = CSV.read(csvFile)
@results.shift
...
############################################
csvFile = "#{Rails.root}/db/seed_data/officialNeighborhood.csv"
@results = CSV.read(csvFile)
@results.shift
...
def load_streets_gml(filename)
  f = File.open("#{Rails.root}/db/seed_data/#{filename}")
  doc = Nokogiri::XML(f)
